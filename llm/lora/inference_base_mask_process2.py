...
result_dict = {}
chatbot = ChatBot("~llm/ft_models/rlhf/netflix_final_rlhf_testmaskv1_output_process_batch_8_fixed_step_2000")
...
output_f = open('~data/netflix/user_profile/netflix_final_rlhf_testmaskv1_batch_8_step_2000/user_profile_dict.pkl', 'wb')
