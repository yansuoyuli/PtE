...
result_dict = {}
chatbot = ChatBot("~llm/ft_models/rlhf/netflix_final_rlhf_testmaskv1__origin_output_fixed_step_2000")
...
output_f = open('~data/netflix/user_profile/netflix_final_rlhf_testmaskv1_step_2000_origin/user_profile_dict.pkl', 'wb')
