...
class ScriptArguments:
    ...
    rm_adapter: Optional[str] = field(
        default="~llm/ft_models/netflix/rlhf/implicit_prm2/checkpoint-2500", metadata={"help": "the rm adapter name"}
    )
...
for epoch, batch in tqdm(enumerate(ppo_trainer.dataloader)):
    ...
    if epoch and epoch % 500 == 0:
        ppo_trainer.save_pretrained('~llm/ft_models/rlhf/netflix_final_rlhf_testmaskv1_output_process_batch_8_fixed_' + f"step_{epoch}")
