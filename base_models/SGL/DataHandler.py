...
class DataHandler:
	def __init__(self):
		...
		if args.data == 'netflix':
			self.userfile = "~data/netflix/user_profile/netflix_final_rlhf_testmaskv1_batch_4_step_2000/item_profile_embeddings.npy" #"~data/netflix/user_profile/netflix_final_rlhf_testmaskv1_step_2000_origin/user_profile_embeddings.npy"#predir + 'user_profile/user_profile_embeddings.npy'#predir + 'user_profile/user_profile_embeddings.npy' predir + 'user_profile/user_profile_embeddings.npy'# "~data/netflix/user_profile/netflix_final_rlhf_testmaskv1_batch_4_step_2000/item_profile_embeddings.npy" #
